...
pub fn calculate_macros(foods: &[Food]) -> json::JsonValue {
    ...
    for food in foods {
        ...
        total_proteins += food.proteins * food.nbr_of_portions.unwrap_or(0.0);
        total_fats += food.fats * food.nbr_of_portions.unwrap_or(0.0);
        total_carbs += food.carbs * food.nbr_of_portions.unwrap_or(0.0);
    }
